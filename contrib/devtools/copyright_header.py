...
Arguments:
    <base_directory> - The base directory of a Cadex Core source code repository.
...
Arguments:
    <base_directory> - The base directory of Cadex Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Cadex Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Cadex
