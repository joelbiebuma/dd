...
#define BOOST_TEST_MODULE Cadex Test Suite

#include "test_cadex.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_cadex_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
