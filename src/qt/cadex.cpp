...
{
    return QCoreApplication::translate("cadex-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. bitcoin_de.qm (shortcut "de" needs to be defined in cadex.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. bitcoin_de_DE.qm (shortcut "de_DE" needs to be defined in cadex.qrc)
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // cadex: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(cadex);
    Q_INIT_RESOURCE(cadex_locale);
    ...
    /// 6. Determine availability of data directory and parse cadex.conf
    ...
    // cadex: links repeatedly have their payment requests routed to this process:
