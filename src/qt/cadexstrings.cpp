...
#define UNUSED
#endif
static const char UNUSED *cadex_strings[] = {
...
QT_TRANSLATE_NOOP("cadex-core", "Add a node to connect to and attempt to keep the connection open"),
QT_TRANSLATE_NOOP("cadex-core", "Allow DNS lookups for -addnode, -seednode and -connect"),
QT_TRANSLATE_NOOP("cadex-core", "Allow RFC1918 addresses to be relayed and connected to (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Already have that input."),
QT_TRANSLATE_NOOP("cadex-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("cadex-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("cadex-core", "Automatic backups disabled"),
QT_TRANSLATE_NOOP("cadex-core", "Automatically create Tor hidden service (default: %d)"),
QT_TRANSLATE_NOOP("cadex-core", "Block creation options:"),
QT_TRANSLATE_NOOP("cadex-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("cadex-core", "Can't mix while sync in progress."),
QT_TRANSLATE_NOOP("cadex-core", "Can't mix: no compatible inputs found!"),
QT_TRANSLATE_NOOP("cadex-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("cadex-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("cadex-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("cadex-core", "Chain selection options:"),
QT_TRANSLATE_NOOP("cadex-core", "Change index out of range"),
QT_TRANSLATE_NOOP("cadex-core", "Collateral not valid."),
QT_TRANSLATE_NOOP("cadex-core", "Connect through SOCKS5 proxy"),
QT_TRANSLATE_NOOP("cadex-core", "Connect to KeePassHttp on port <port> (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Connect to a node to retrieve peer addresses, and disconnect"),
...
QT_TRANSLATE_NOOP("cadex-core", "Error initializing wallet database environment %s!"),
QT_TRANSLATE_NOOP("cadex-core", "Error loading %s"),
QT_TRANSLATE_NOOP("cadex-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("cadex-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("cadex-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
QT_TRANSLATE_NOOP("cadex-core", "Error loading block database"),
QT_TRANSLATE_NOOP("cadex-core", "Error opening block database"),
QT_TRANSLATE_NOOP("cadex-core", "Error reading from database, shutting down."),
QT_TRANSLATE_NOOP("cadex-core", "Error upgrading chainstate database"),
QT_TRANSLATE_NOOP("cadex-core", "Error"),
QT_TRANSLATE_NOOP("cadex-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("cadex-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("cadex-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("cadex-core", "Failed to create backup, error: %s"),
...
QT_TRANSLATE_NOOP("cadex-core", "Found enough users, signing ..."),
QT_TRANSLATE_NOOP("cadex-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("cadex-core", "Importing..."),
QT_TRANSLATE_NOOP("cadex-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("cadex-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("cadex-core", "Incompatible version."),
QT_TRANSLATE_NOOP("cadex-core", "Incorrect or no genesis block found. Wrong datadir for network?"),
QT_TRANSLATE_NOOP("cadex-core", "Information"),
QT_TRANSLATE_NOOP("cadex-core", "Initialization sanity check failed. %s is shutting down."),
...
QT_TRANSLATE_NOOP("cadex-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("cadex-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("cadex-core", "Mnemonic passphrase is too long, must be at most 256 characters"),
QT_TRANSLATE_NOOP("cadex-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("cadex-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("cadex-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("cadex-core", "No errors detected."),
QT_TRANSLATE_NOOP("cadex-core", "No matching denominations found for mixing."),
QT_TRANSLATE_NOOP("cadex-core", "Node relay options:"),
QT_TRANSLATE_NOOP("cadex-core", "Non-standard public key detected."),
QT_TRANSLATE_NOOP("cadex-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("cadex-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("cadex-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("cadex-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("cadex-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("cadex-core", "PrivateSend is idle."),
QT_TRANSLATE_NOOP("cadex-core", "PrivateSend options:"),
QT_TRANSLATE_NOOP("cadex-core", "PrivateSend request complete:"),
QT_TRANSLATE_NOOP("cadex-core", "PrivateSend request incomplete:"),
QT_TRANSLATE_NOOP("cadex-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("cadex-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("cadex-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("cadex-core", "RPC server options:"),
QT_TRANSLATE_NOOP("cadex-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("cadex-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("cadex-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
QT_TRANSLATE_NOOP("cadex-core", "Relay and mine data carrier transactions (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Rescan the block chain for missing wallet transactions on startup"),
QT_TRANSLATE_NOOP("cadex-core", "Rescanning..."),
QT_TRANSLATE_NOOP("cadex-core", "Run in the background as a daemon and accept commands"),
QT_TRANSLATE_NOOP("cadex-core", "Send trace/debug info to console instead of debug.log file"),
QT_TRANSLATE_NOOP("cadex-core", "Send trace/debug info to debug.log file (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Session not complete!"),
QT_TRANSLATE_NOOP("cadex-core", "Session timed out."),
...
QT_TRANSLATE_NOOP("cadex-core", "Signing transaction failed"),
...
QT_TRANSLATE_NOOP("cadex-core", "This is experimental software."),
QT_TRANSLATE_NOOP("cadex-core", "This is not a Masternode."),
QT_TRANSLATE_NOOP("cadex-core", "This is the minimum transaction fee you pay on every transaction."),
...
QT_TRANSLATE_NOOP("cadex-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("cadex-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("cadex-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("cadex-core", "Transaction has too long of a mempool chain"),
...
QT_TRANSLATE_NOOP("cadex-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("cadex-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("cadex-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("cadex-core", "Unknown response."),
QT_TRANSLATE_NOOP("cadex-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("cadex-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("cadex-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("cadex-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("cadex-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("cadex-core", "Upgrading UTXO database"),
QT_TRANSLATE_NOOP("cadex-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("cadex-core", "Use devnet chain with provided name"),
QT_TRANSLATE_NOOP("cadex-core", "Use the test chain"),
QT_TRANSLATE_NOOP("cadex-core", "User Agent comment (%s) contains unsafe characters."),
QT_TRANSLATE_NOOP("cadex-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("cadex-core", "Verifying blocks..."),
QT_TRANSLATE_NOOP("cadex-core", "Verifying wallet..."),
QT_TRANSLATE_NOOP("cadex-core", "Very low number of keys left: %d"),
...
QT_TRANSLATE_NOOP("cadex-core", "Warning"),
QT_TRANSLATE_NOOP("cadex-core", "Warning: unknown new rules activated (versionbit %i)"),
...
QT_TRANSLATE_NOOP("cadex-core", "ZeroMQ notification options:"),
QT_TRANSLATE_NOOP("cadex-core", "no mixing available."),
QT_TRANSLATE_NOOP("cadex-core", "see debug.log for details."),
};
