...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("cadexcoin.tech", "dnsseed.cadexcoin.tech"));
        vSeeds.push_back(CDNSSeedData("cadexcoin.online", "dnsseed.cadexcoin.online"));
        ...
        chainTxData = ChainTxData{
            1544298537, // * UNIX timestamp of last known number of transactions (Block 1068571)
            102,   // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0.1 9        // * estimated number of transactions per second after that timestamp
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("cadexdot.io",  "testnet-seed.cadexdot.io"));
        ...
        chainTxData = ChainTxData{
            1544267395, // * UNIX timestamp of last known number of transactions (Block 96717)
...
public:
    CDevNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("cadexevo.org",  "devnet-seed.cadexevo.org"));
