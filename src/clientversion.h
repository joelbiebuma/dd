...
//! These need to be macros, as clientversion.cpp's and cadex*-res.rc's voodoo requires it
...
/**
 * cadexd-res.rc includes this file, but it cannot cope with real c++ code.
