...
This mechanism has been integrated into Bitcore-Node-Cadex which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cadexproject/insight-api-cadex#web-socket-api](https://github.com/cadexproject/insight-api-cadex#web-socket-api)
* API: [https://github.com/cadexproject/insight-api-cadex#instantsend-transactions](https://github.com/cadexproject/insight-api-cadex#instantsend-transactions)
