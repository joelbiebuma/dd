...
This document provides guidelines for internationalization of the Cadex Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cadex_en.ts` remains unchanged.
